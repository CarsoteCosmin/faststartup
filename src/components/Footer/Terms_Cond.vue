<template>
  <v-container style="color:white;background-color:black;" fluid>
    <h2 class="text-center"><strong>Terms and Conditions</strong></h2>

    <p>Welcome to FastStartUp!</p>

    <p>
      These terms and conditions outline the rules and regulations for the use
      of FlameCode SRL's Website, located at https://faststartup.tech/.
    </p>

    <p>
      By accessing this website we assume you accept these terms and conditions.
      Do not continue to use FastStartUp if you do not agree to take all of the
    ...
    <p>
      We employ the use of cookies. By accessing FastStartUp, you agreed to use
      cookies in agreement with the FlameCode SRL's Privacy Policy.
    </p>
    ...
    <p>
      Unless otherwise stated, FlameCode SRL and/or its licensors own the
      intellectual property rights for all material on FastStartUp. All
      intellectual property rights are reserved. You may access this from
      FastStartUp for your own personal use subjected to restrictions set in
      these terms and conditions.
    </p>

    <p>You must not:</p>
    <ul>
      <li>Republish material from FastStartUp</li>
      <li>Sell, rent or sub-license material from FastStartUp</li>
      <li>Reproduce, duplicate or copy material from FastStartUp</li>
      <li>Redistribute content from FastStartUp</li>
    </ul>
    ...
    <p>
      ...
      opinions and information in certain areas of the website. FlameCode SRL
      ...
      FlameCode SRL,its agents and/or affiliates. Comments reflect the views and
      opinions of the person who post their views and opinions. To the extent
      permitted by applicable laws, FlameCode SRL shall not be liable for the
    ...
    <p>
      FlameCode SRL reserves the right to monitor all Comments and to remove any
    ...
    <p>
      You hereby grant FlameCode SRL a non-exclusive license to use, reproduce,
    ...
    <p>
      ...
      hyperlink compensates the absence of FlameCode SRL; and (d) the link is in
    ...
    <p>
      ...
      e-mail to FlameCode SRL. Please include your name, your organization name,
    ...
    <p>
      No use of FlameCode SRL's logo or other artwork will be allowed for
